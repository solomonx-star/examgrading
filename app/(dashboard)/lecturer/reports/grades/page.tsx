...
export default async function LecturerGradeReportPickerPage({
  searchParams,
}: {
  ...
  return (
    <div>
      <PageHeader
        title="Grade report"
        description="Pick one of your modules to view or export its grade report."
      />
                ...
                return (
                  <tr key={id} className="hover:bg-whiter">
                    ...
                    <td className="px-4 py-3 text-right">
                      <Link
                        href={`/lecturer/reports/grades/${id}`}
