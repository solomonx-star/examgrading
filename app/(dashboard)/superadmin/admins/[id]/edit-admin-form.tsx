...
export function EditAdminForm({
  ...
  const bound = updateAdminAction.bind(null, id);
  const [state, formAction] = useActionState<FormState, FormData>(
    bound,
    undefined,
  );
  useToastFromState(state, { successMessage: "Admin updated." });
  ...
  return (
    ...
    >
      ...
      <fieldset className="space-y-2 pt-1">
        <Checkbox id="isActive" label="Active" defaultChecked={defaults.isActive} />
        <Checkbox
